...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ItemTemplate>
        <table class="auto-style4">
            <tr>
                <td style="background-color: #FF3300"><strong><a href="YemekDetay.aspx?yemekid=<%# Eval("Yemek_Id") %>">
                    <asp:Label ID="Label4" runat="server" CssClass="auto-style5" Text='<%# Eval("Yemek_Ad") %>'></asp:Label>
                    </a></strong></td>
            </tr>
            <tr>
